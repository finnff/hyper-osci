...
| 10 kΩ potentiometer, PCB/panel mount, linear | 5 | + knobs. ⚠️ **Pot style + knob shaft length STILL OPEN** — tentative default PCB-mount 9 mm RV09; do NOT finalize the footprint yet. Match footprint to pcb.md once decided. |

...
| 9-pin header distance from 6-pin row | — | **PROVISIONAL (Finn, phone-measured)** — everything on the common 0.1″ grid: the 1×6 row axis sits **+2.54 mm** from the 1×9's digital-end pin (FLT), and **SCK is collinear with the 1×9 row** (Δy = 0); BCK/DIN follow at −2.54/−5.08 mm (≈3.59/≈5.68 mm euclidean from FLT). ⚠️ confirm with the 1:1 paper-doll print before ordering | 2026-07-24 |
